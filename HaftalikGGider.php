...
<div class="col-xl-11 mx-auto mt-2  items-align-center">
        ...
        <div class="col-lg-12">
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="row ml-4 mt-5 mr-5 ">
              <div class="col-xl-3">
                <label for="" class="text-info">Tarih</label>
            ...
            <button type="submit" class="btn btn-info  ml-5 mb-3 mt-5">
  ...
  <div class="col-xl-11 mx-auto mt-2  items-align-center">
    <div class="row mt-5">
      <?php for ($i = 1; $i <= 3; $i++) {
        if ($i == 1) {
          $baslik = "Haftalık Toplam Gelir";
          $color = "success";
        }
        if ($i == 2) {
          $baslik = "Haftalık Toplam Gider";
          $color = "danger";
        }
        if ($i == 3) {
          $baslik = "Haftalık Toplam Kar ";
          $color = "warning";
        }
        ?>
        ...
        $htoplamGider = $db->getRow("SELECT SUM(gider) AS giderh FROM gelirgider  WHERE datee BETWEEN '$dateilk' AND '$dateson'");
        $htoplamKar = $db->getRow("SELECT SUM(kar) AS karh FROM gelirgider  WHERE datee BETWEEN '$dateilk' AND '$dateson'");
                ...
                <div class="col mr-2">
                  <div class="h5 mb-2 font-weight-bold text-gray-800">
                    ...
                    <div class="text-<?php echo $color; ?>">
                      <?php if ($i == 1) {
                        echo $htoplamGelir->gelirh;
                      }
                      if ($i == 2) {
                        echo $htoplamGider->giderh;
                      }
                      if ($i == 3) {
                        echo $htoplamKar->karh;
                      }
                      if ($i == 4) {
                        echo $Notecount;
                      } ?> ₺
          ...
          <div class="col-lg-12">
            <div class=" ml-5 mt-5 mr-5 text-danger text-center">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <thead class="text-light bg-<?php if($htoplamGelir->gelirh>=$htoplamGider->giderh){
                  echo "success"; 
                }if($htoplamGelir->gelirh<$htoplamGider->giderh){
                  echo "danger";
                } ?>">
                  <tr>
